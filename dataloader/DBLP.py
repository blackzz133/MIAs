...
class DBLPELoader(object):
    ...
    def _get_targets_and_features(self):
        self.targets = torch.tensor(self.Labels).transpose(0, 1).numpy()
        self.features = []
        url = 'node_features.feature'
